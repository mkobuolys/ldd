import 'package:gskinner_example/views/demo_chrome.dart';
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage(
              'assets/images/card_deck/background.jpg',
              package: 'gskinner_example',
            ),
            fit: BoxFit.cover,
          ),
        ),
    ...
    Widget card = AspectRatio(
      ...
      child: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage(
              'assets/images/card_deck/card-$index.jpg',
              package: 'gskinner_example',
            ),
            fit: BoxFit.cover,
          ),
